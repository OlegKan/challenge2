...
import com.simplaapliko.challenge2.data.datasource.remote.rx.GetAirportsSingle;
...
public class RemoteAirportDataSource implements AirportDataSource {

    private final OkHttpClient okHttpClient;
    private final Gson gson;
    private final Cache.Airport cache;

    public RemoteAirportDataSource(OkHttpClient okHttpClient, Gson gson, Cache.Airport cache) {
